...
hist(as.matrix(county_differences[,"dem_pct_difference_weighted"]))

scores_inv[is.na(scores_inv)] = 0

#Cumulative weight on each row
hist(apply(scores_inv,1,sum))
...
hist(as.matrix(county_differences[,"turnout_pct_difference_weighted"]))
...
#Distribution of shifts
hist(county_demo_turnout_shift,25)
